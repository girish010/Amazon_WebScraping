...
public class Snuza2 extends Cocoon2 
{
	@Test
	public  void Snuza2_Smart(String urls) throws IOException, InterruptedException
	{
		...
		// creating second row		 
		Row row2 = sheet.createRow((short) 10);
	...
	@Test
	public  void Nanit_Monitor(String urls) throws IOException, InterruptedException
	{
		int ulr=urls.length();
		System.setProperty("webdriver.chrome.driver", "./Drivers/chromedriver.exe");
		WebDriver driver=new ChromeDriver();
	...
	@Test
	public  void Snuza_Monitor(String urls) throws IOException, InterruptedException
	{
		System.setProperty("webdriver.chrome.driver", "./Drivers/chromedriver.exe");
		WebDriver driver=new ChromeDriver();
		//driver.get("https://www.amazon.com/Nanit-Complete-Monitor-System-Breathing/dp/B07P98D67X");
	...
	public void Cocoon1_monitor(String urls) throws IOException, InterruptedException
	{
	System.setProperty("webdriver.chrome.driver", "./Drivers/chromedriver.exe");
	WebDriver driver=new ChromeDriver();
	//driver.get("https://www.amazon.com/Nanit-Complete-Monitor-System-Breathing/dp/B07P98D67X");
	...
	@Test
	public void Owlet_monitor(String urls) throws IOException, InterruptedException
	{
		System.setProperty("webdriver.chrome.driver", "./Drivers/chromedriver.exe");
		WebDriver driver=new ChromeDriver();
		//driver.get("https://www.amazon.com/Nanit-Complete-Monitor-System-Breathing/dp/B07P98D67X");
	...
	@Test
	public  void Lollipop_Smart(String urls) throws IOException, InterruptedException
	{
	...
	@Test
	public  void Owlet2_Smart(String urls) throws IOException, InterruptedException
	{
		...
		// creating second row		 
		Row row2 = sheet.createRow((short) 7);
	...
	@Test
	public  void Arlo_Smart(String urls) throws IOException, InterruptedException
	{
	...
	@Test
	public  void Cocoon2_Smart(String urls) throws IOException, InterruptedException
	{
		...
		// creating second row		 
		Row row2 = sheet.createRow((short) 9);
